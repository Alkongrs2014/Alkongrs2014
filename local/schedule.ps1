...
$tasks = @(
  ...
  # دفتر الكريبتو — 24/7 بعد إغلاق شمعة الربع ساعة بدقيقتين. قفلُه وملفّاته
  # في data\crypto وحده، فلا ينتظر مهمّةَ أسهم ولا تنتظره. وبلا --publish:
  # مهمّةُ النشر المستقلّة تنشر المجلّد كلَّه كل دقيقتين.
  @{ Name='WebTrade-Crypto';  Job='crypto';  Every=15; Start='00:02'; LimitMin=10;  Desc='دفتر الكريبتو — شموع ومحرّك ولقطة فرص' }
)
