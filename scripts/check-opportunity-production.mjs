...
moved
  ? ok("السعر اللحظي تحرّك بين العيّنات", `${moved} تغيّراً من ${common} مقارنة — فالثبات ليس سكوناً`)
  : no("السعر اللحظي تحرّك بين العيّنات", "لم يتحرّك سعرٌ واحد — الاختبار لا يُثبت شيئاً، أعِده والسوق يتحرّك");
